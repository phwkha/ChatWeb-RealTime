...
class RoleServiceTest {
    ...
    void setUp() {
        ...
        GrantedAuthority auth1 = new SimpleGrantedAuthority("P1");
        GrantedAuthority auth2 = new SimpleGrantedAuthority("P2");
        lenient().doReturn(List.of(auth1, auth2)).when(authentication).getAuthorities();
    }

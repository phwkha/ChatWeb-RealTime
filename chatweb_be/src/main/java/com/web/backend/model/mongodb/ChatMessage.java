...
@CompoundIndex(name = "unread_msg_idx", def = "{'recipient': 1, 'status': 1, 'messageType': 1, 'sender': 1}")
@CompoundIndex(name = "conv_content_time_idx", def = "{'conversationId': 1, 'messageType': 1, 'isDeleted': 1, 'timestamp': -1}")
@CompoundIndex(name = "conv_recipient_status_idx", def = "{'conversationId': 1, 'recipient': 1, 'status': 1, 'messageType': 1}")
